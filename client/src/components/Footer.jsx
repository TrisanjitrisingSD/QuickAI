                ...
                <div className="md:max-w-96">
                    <img className="h-9" src={assets.favicon} alt="logo" />
                        <p className="mt-6 text-sm" >
                            Experience The Power of AI with WarniFy. <br />transform your content creation with our suite of premium AI tools.Write articles,generate images and enhance your workflow.
                        </p>
                </div>
