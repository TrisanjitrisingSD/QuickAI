...
import { Hash, Image, House, SquarePen, Eraser, Scissors, FileText, Users, LogOut, Newspaper, MessageCircle } from 'lucide-react';
...
const navItems = [
    ...
    { to: '/ai/chatt', label: 'Chat', Icon: MessageCircle }
]
...
const Sidebar = ({ sidebar, setSidebar }) => {
    ...
    return (
        <div className={`w-60 bg-white border-r h-full  border-gray-200 flex flex-col justify-between items-center max-sm:absolute top-14 bottom-0
    ...
    `}>
     ...
     hover:scale-105 hover:bg-green-300
            ...
            <div className='w-full border-t border-gray-200 p-4 px-7 flex items-center justify-between'>
                <div className='flex gap-2 items-center cursor-pointer' onClick={openUserProfile}>
                    ...
                    <div>
                        ...
                        <p className='text-x5 text-gray-500'>
